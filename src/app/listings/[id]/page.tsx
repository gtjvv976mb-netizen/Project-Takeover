      ...
      <aside className="h-fit space-y-4 border border-rule bg-paper p-5 lg:sticky lg:top-24">
        ...
        {isSeller && l.status === "paid" && l.type !== "token_authority" && (
          <div className="space-y-2">
            ...
            {l.type === "pump_creator" && <p className="break-all text-xs text-mute">Transfer coin ownership to <span className="font-mono">{l.buyer}</span> on pump.fun, then verify below to get paid instantly.</p>}
